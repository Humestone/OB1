...
| ------------ | ------------ | ------- |
| [Bootstrap the hardened OB1 Review gate](.github/workflows/ob1-gate-v2.yml) | Bootstrap the hardened OB1 Review gate. | [@Humestone](https://github.com/Humestone) |
| [Agent-memory-api: dedicated AGENT_MEMORY_ACCESS_KEY dual-key auth (+ Phase 10 lineage sync)](integrations/agent-memory-api/) | Agent-memory-api: dedicated AGENT_MEMORY_ACCESS_KEY dual-key auth (+ Phase 10 lineage sync). | [@Humestone](https://github.com/Humestone) |
| [Sync fork with upstream OB1 (176 commits) + preserve local hardening](dashboards/ob1-canonical-landing/) | Sync fork with upstream OB1 (176 commits) + preserve local hardening. | [@Humestone](https://github.com/Humestone) |
| [Harden ob1-gate.yml against gate-bypass holes](.github/workflows/ob1-gate.yml) | Harden ob1-gate.yml against gate-bypass holes. | [@Humestone](https://github.com/Humestone) |
| [Harden OB1 PR Gate: add ready_for_review trigger + branch protection instructions](.github/workflows/ob1-gate.yml) | Harden OB1 PR Gate: add ready_for_review trigger + branch protection instructions. | [@Humestone](https://github.com/Humestone) |
