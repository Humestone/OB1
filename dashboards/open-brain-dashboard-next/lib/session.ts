...
/*
 * Session config shared by lib/auth.ts (server components / API routes) and
 * proxy.ts (request-time session validation). Kept free of next/headers and
 * next/navigation imports so the proxy can bundle it.
 */
